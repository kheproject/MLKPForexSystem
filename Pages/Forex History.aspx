<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Forex History.aspx.vb" Inherits="Pages_Forex_History" title="Forex History" %>
                        ...
                        BorderWidth="1px" Font-Overline="False" Font-Strikeout="False">
                         ...
                         <Columns>
                               ...
                               <asp:TemplateField HeaderText="CURRENCY" 
                                   HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="80" ItemStyle-HorizontalAlign="Center">
                                 <ItemTemplate>
                                     <%#Eval("currname")%>
                                 </ItemTemplate>
